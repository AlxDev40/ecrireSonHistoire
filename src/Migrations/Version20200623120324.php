 ...
 */
final class Version20200623120324 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE road ADD class_constraint VARCHAR(255) DEFAULT NULL, CHANGE chapter_id chapter_id INT DEFAULT NULL, CHANGE target_chapter_id target_chapter_id INT DEFAULT NULL');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE road DROP class_constraint, CHANGE chapter_id chapter_id INT DEFAULT NULL, CHANGE target_chapter_id target_chapter_id INT DEFAULT NULL');
    }
}
