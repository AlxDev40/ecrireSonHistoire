 ...
 */
final class Version20200626124507 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE road ADD necessary_message LONGTEXT DEFAULT NULL, CHANGE chapter_id chapter_id INT DEFAULT NULL, CHANGE target_chapter_id target_chapter_id INT DEFAULT NULL, CHANGE necessary_id necessary_id INT DEFAULT NULL, CHANGE class_constraint class_constraint VARCHAR(255) DEFAULT NULL');
