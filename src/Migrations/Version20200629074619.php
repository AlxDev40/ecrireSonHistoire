 ...
 */
final class Version20200629074619 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE road DROP message, CHANGE chapter_id chapter_id INT DEFAULT NULL, CHANGE target_chapter_id target_chapter_id INT DEFAULT NULL, CHANGE necessary_id necessary_id INT DEFAULT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE equipment CHANGE attack attack INT DEFAULT NULL, CHANGE defense defense INT DEFAULT NULL');
        $this->addSql('ALTER TABLE road ADD message VARCHAR(255) CHARACTER SET utf8mb4 DEFAULT \'NULL\' COLLATE `utf8mb4_unicode_ci`, CHANGE chapter_id chapter_id INT DEFAULT NULL, CHANGE target_chapter_id target_chapter_id INT DEFAULT NULL, CHANGE necessary_id necessary_id INT DEFAULT NULL');
