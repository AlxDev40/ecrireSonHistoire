 ...
 */
final class Version20200617051826 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE chapter DROP itinerary');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE book CHANGE user_id user_id INT DEFAULT NULL');
        $this->addSql('ALTER TABLE chapter ADD itinerary VARCHAR(255) CHARACTER SET utf8mb4 DEFAULT \'NULL\' COLLATE `utf8mb4_unicode_ci`');
