 ...
 */
final class Version20200618092102 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE road ADD name VARCHAR(255) DEFAULT NULL, CHANGE target_chapter_id target_chapter_id INT DEFAULT NULL');
    }
