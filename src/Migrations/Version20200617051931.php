 ...
 */
final class Version20200617051931 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE road DROP itinerary, CHANGE target_chapter_id target_chapter_id INT DEFAULT NULL');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE road ADD itinerary VARCHAR(255) CHARACTER SET utf8mb4 DEFAULT \'NULL\' COLLATE `utf8mb4_unicode_ci`, CHANGE target_chapter_id target_chapter_id INT DEFAULT NULL');
    }
}
