 ...
 */
final class Version20200618122007 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE road ADD paragraph LONGTEXT DEFAULT NULL, CHANGE target_chapter_id target_chapter_id INT DEFAULT NULL');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE road DROP paragraph, CHANGE target_chapter_id target_chapter_id INT DEFAULT NULL');
    }
}
