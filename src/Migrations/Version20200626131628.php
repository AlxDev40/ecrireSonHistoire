 ...
 */
final class Version20200626131628 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE road ADD message VARCHAR(255) DEFAULT NULL, CHANGE chapter_id chapter_id INT DEFAULT NULL, CHANGE target_chapter_id target_chapter_id INT DEFAULT NULL, CHANGE necessary_id necessary_id INT DEFAULT NULL, CHANGE class_constraint class_constraint VARCHAR(255) DEFAULT NULL, CHANGE necessary_message necessary_message VARCHAR(255) DEFAULT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE equipment CHANGE attack attack INT DEFAULT NULL, CHANGE defense defense INT DEFAULT NULL');
        $this->addSql('ALTER TABLE road DROP message, CHANGE chapter_id chapter_id INT DEFAULT NULL, CHANGE target_chapter_id target_chapter_id INT DEFAULT NULL, CHANGE necessary_id necessary_id INT DEFAULT NULL, CHANGE class_constraint class_constraint VARCHAR(255) CHARACTER SET utf8mb4 DEFAULT \'NULL\' COLLATE `utf8mb4_unicode_ci`, CHANGE necessary_message necessary_message VARCHAR(255) CHARACTER SET utf8mb4 DEFAULT \'NULL\' COLLATE `utf8mb4_unicode_ci`');
        $this->addSql('ALTER TABLE user CHANGE roles roles JSON CHARACTER SET utf8mb4 DEFAULT \'NULL\' COLLATE `utf8mb4_bin` COMMENT \'(DC2Type:json_array)\'');
    }
}
