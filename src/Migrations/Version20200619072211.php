 ...
 */
final class Version20200619072211 extends AbstractMigration
{
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE road CHANGE chapter_id chapter_id INT NOT NULL, CHANGE target_chapter_id target_chapter_id INT DEFAULT NULL');
    }
}
