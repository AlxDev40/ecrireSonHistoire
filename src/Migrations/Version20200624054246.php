 ...
 */
final class Version20200624054246 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE equipment ADD attack INT DEFAULT NULL, ADD defense INT DEFAULT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE equipment DROP attack, DROP defense');
